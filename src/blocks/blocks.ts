...
import './hoisting'; // Tidies code generated by Blockly's stock blocks.
import './classes'; // Class blocks; must follow functions.ts.
import './turtle'; // Turtle graphics, added to the palette on demand.
